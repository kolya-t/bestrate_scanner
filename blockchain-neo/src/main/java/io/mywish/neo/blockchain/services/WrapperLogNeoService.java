...
public class WrapperLogNeoService {
    @Autowired
    private List<Web3ContractEventBuilder<?>> builders = new ArrayList<>();
    private Map<String, Web3ContractEventBuilder<?>> buildersByName = new HashMap<>();
...
//        put("0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0", "transferOwnership");
    ...
    public ContractEvent build(Event event) {
        Web3ContractEventBuilder builder = buildersByName.get(event.getName());
        if (builder == null) {
